...
BINARIES= \
	$(OUTDIR)/yugen $(OUTDIR)/yedit $(OUTDIR)/yang
GEN= \
	./gen
SOURCE= \
	./source
...
# TODO: make this work.
#$(OUTDIR)/%: \
#	./depend/.build $(OBJECTS)
#	@echo Linking ./$@
#	$(CXX) -o ./$@ \
#	    $(filter-out $(filter-out $(OUTDIR)/%.cpp.o,$(MAIN_OBJECTS)),$(OBJECTS)) \
#	    $(LFLAGS)
$(OUTDIR)/yugen: \
	./depend/.build $(OBJECTS)
	@echo Linking ./$@
	$(CXX) -o ./$@ \
	    $(filter-out \
			$(filter-out $(OUTDIR)/yugen.cpp.o,$(MAIN_OBJECTS)),$(OBJECTS)) $(LFLAGS)
$(OUTDIR)/yedit: \
	./depend/.build $(OBJECTS)
	@echo Linking ./$@
	$(CXX) -o ./$@ \
	    $(filter-out \
			$(filter-out $(OUTDIR)/yedit.cpp.o,$(MAIN_OBJECTS)),$(OBJECTS)) $(LFLAGS)
$(OUTDIR)/yang: \
	./depend/.build $(OBJECTS)
	@echo Linking ./$@
	$(CXX) -o ./$@ \
	    $(filter-out \
			$(filter-out $(OUTDIR)/yang.cpp.o,$(MAIN_OBJECTS)),$(OBJECTS)) $(LFLAGS)
